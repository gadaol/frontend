  ...
  if (!invite) {
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <h1 className="text-ink text-[20px] font-bold">{t('inviteExpired')}</h1>
        <p className="text-ink3 text-[14px]">{t('inviteExpiredDesc')}</p>
      </div>
    )
  }
    ...
    return (
      <div className="flex min-h-dvh flex-col">
        ...
        <div className="flex flex-1 flex-col px-6 pt-6 pb-10">
          <p className="text-primary mb-1 text-[13px] font-medium">{t('tripInvite')}</p>
          ...
          <p className="text-ink3 mb-8 text-[14px]">{t('joinNeedAccount')}</p>
          <a
      ...
      <div className="flex flex-1 flex-col px-6 pt-6 pb-10">
        ...
        {trip.start_date && (
          <p className="text-ink3 mb-6 text-[14px]">
            {trip.start_date} ~ {trip.end_date ?? t('dateTbd')}
          </p>
        )}
